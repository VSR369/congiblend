-- Add missing columns to posts table and create missing tables
DO $$ 
BEGIN
...
CREATE POLICY IF NOT EXISTS "Users can delete their own shares"
...
CREATE POLICY IF NOT EXISTS "Users can view all RSVPs"
