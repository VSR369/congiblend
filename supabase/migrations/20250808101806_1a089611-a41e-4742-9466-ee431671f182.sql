...
-- Drop unused organization context table
DROP TABLE IF EXISTS public.organization_context CASCADE;
...
DROP TABLE IF EXISTS public.solution_seekers_comprehensive_view CASCADE;

-- Keep essential tables:
-- posts, profiles, users, reactions, votes, media_processing, follows, connections
-- organizations (basic org data), master_* tables that are simple and may be used